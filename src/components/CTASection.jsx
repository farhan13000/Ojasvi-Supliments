    ...
    <section className="relative overflow-hidden py-20 sm:py-24">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="font-display relative text-3xl text-cream sm:text-4xl">
            Ready to Feel Your <span className="text-gradient-gold">Best Energy</span> Again?
          </h2>
          <p className="relative mx-auto mt-4 max-w-xl text-cream/70">
            Join thousands who trust Ojasvi for natural, Ayurvedic stamina support. Order today and pay on delivery.
          </p>
