// Product catalog. Today there's one available product (Strength+) and a
// couple of "coming soon" teasers — add more entries here as the range
// grows; the homepage catalog grid and structured data pick them up
// automatically.
...
export const products = [
  ...
  },
  {
    ...
    teaser: 'Brahmi, Shankhpushpi & Jyotishmati — for calm, sustained focus through the day.',
  },
  {
    id: 'immunity-plus',
    status: 'coming-soon',
    ...
    category: 'Immunity',
    teaser: 'Giloy, Amla & Tulsi — to support your body’s natural daily defenses.',
  },
]
