...
export default function ProductDetail() {
  ...
  if (!product || product.status !== 'available') {
    return (
      <>
        <SEO title="Product Not Found | Ojashvi Supplements" description="This product doesn't exist or isn't available yet." path={`/products/${id ?? ''}`} noindex />
  ...
  return (
    <>
      <SEO
        title={`${brand.shortName} ${product.name} | ${product.subtitle} – Buy Online`}
